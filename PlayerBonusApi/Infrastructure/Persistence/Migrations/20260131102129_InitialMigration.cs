    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_player_bonuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_player_bonuses_players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_player_bonuses_PlayerId_BonusType",
                table: "player_bonuses",
                columns: new[] { "PlayerId", "BonusType" },
                unique: true,
